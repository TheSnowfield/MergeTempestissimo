            ...
            var a = e("./GameManager"),
                ...
                f = function (e) {
                    ...
                    return o(t, e), n = t, t.prototype.onLoad = function () {
                        ...
                        this.gengduoyouxi.getComponent(cc.Sprite).spriteFrame = this.gengduoyouxiarr[t - 1], 1 != t && (this.bencichengji.getComponent(cc.Sprite).spriteFrame = this.bencichengjiarr[t - 1]), this.continueTip.getComponent(cc.Label).string = 1 == t ? "\u70b9\u51fb\u7ee7\u7eed" : 2 == t ? "\u9ede\u64ca\u7e7c\u7e8c" : 4 == t ? "\ud074\ub9ad \ud558\uc5ec \uacc4\uc18d" : "Click Continue";
                        var n = i.default.returnCurrentLanType();
                        this.adsButton2.active = 1 == n, this.reStartBtn.runAction(cc.repeatForever(cc.sequence(cc.scaleTo(.5, 1.1), cc.scaleTo(.55, 1), cc.delayTime(.5)))), cc.tween(this.adsButton2).call(function () {
                        ...
                        this.canClick && (this.moreGameBtn.off(cc.Node.EventType.TOUCH_START, this.OnClickMoreGame, this), this.canClick = !1, this.moreGameBtn.runAction(cc.sequence(cc.scaleTo(.1, .7), cc.scaleTo(.1, .6))), this.scheduleOnce(function () {
                            window.location.href = "#"
                        }, .15), cc.log(111111111111))
            ...
            var a = e("../common/PlayerInfo"),
                ...
                m = function (e) {
                    ...
                    return o(t, e), n = t, t.prototype.onLoad = function () {
                        ...
                        m.getComponent(cc.Sprite).spriteFrame = d.default.Instance.guozhiZ[e], m.zIndex = 9999, m.position = h, m.y+=(h.height)*0.35, m.scale = 0, m.angle = 0, m.runAction(cc.sequence(cc.spawn(cc.scaleTo(.2, n / 150), cc.fadeOut(1)), cc.callFunc(function () {
                            m.active = !1
                        })))
    ...
    MainGameJS: [
        function (e, t, n) {
            ...
            cc.Class({
                ...
                onLoad: function () {
                ...
                }, enableButtons: function () {}, addTouchEvents: function () {
                    var e = this;
                    ...
                    var title = tempest ? "Track Complete" : "Track Lost";
                  
                    var e = this,
                        t = this.returnCurrentLanType();
                    1 == t ? (this.gameOverT1.string = title, 
                    this.gameOverT2.string = "再 玩 一 局") : 2 == t ? 
                    (this.gameOverT1.string = title, 
                    this.gameOverT2.string = "點 擊 查 看 分 數") : 4 == t ? 
                    (this.gameOverT1.string = title, 
                    this.gameOverT2.string = "클릭 하여 점수 보기") : 
                    (this.gameOverT1.string = title, this.gameOverT2.string = "Restart Game"), 
                    this.gameOveEndBool = !0, this.gameOverT1.node.zIndex = 999, 
                    this.gameOverT2.node.zIndex = 999, this.gameOverToEnd.zIndex = 999, 
                    this.gameOverT1.node.opacity = 0, this.gameOverT1.node.y = 100, 
                    this.gameOverToEnd.y = 0, this.gameOverT1.node.runAction(cc.sequence(cc.delayTime(.2), 
                    cc.spawn(cc.fadeIn(1), cc.moveBy(1, 0, -50)), cc.delayTime(.3))), 
                    ...
                    if(tempest){
                      y.playAudio("trackclear");
                    }else{
                      y.playAudio("tracklost");
                    }
					
                }, initEndLayer: function () {
                    tempest = false;
                    z.default.Instance.RestartGame();
                ...
                }, start: function () {}, update: function (e) {
            ...
            var o = e("HttpManagerJs"),
                ...
                r = (e("GameUiTools"), {
                    ...
                    init: function (e, t, n) {
                        ...
                        this.moreGameUrl = "https://arcaea.lowiro.com"
                    }, gameOverShowText: function (e, t) { /*this.ajaxLoad("cgi/saveGamescore","gameScore="+e+"&gameId="+this.gameHttpId+"&gameType="+t,this.scoreResult)*/ }, gamePV_load: function () { /*this.ajaxLoad("cgi/gamelogo","gameID="+this.gameHttpId,this.ajaxOnLogoResult)*/ }, ajaxOnLogoResult: function () {}, ajaxLoad: function (e, t, n) {
    ...
    ToolsJs: [
        function (e, t, n) {
            ...
            var o = {
                ...
                }, loadJson: function (e, t) {}, writeJson: function (e, t) {
                    if (cc.sys.isBrowser) {
                        console.log("\u6d4f\u89c8\u5668");
                        var n = new Blob([e], {
        ...
        function (e, t, n) {
            ...
            cc._RF.push(t, "813eeXgvcJG96hqXhg+nvJ0", "bfPrefabJs"), cc.Class({
                ...
                onLoad: function () {
                    ...
                    this.wing_r.runAction(cc.repeatForever(cc.sequence(cc.scaleTo(.2, 1).easing(cc.easeSineInOut()), cc.scaleTo(.2, .4, 1).easing(cc.easeSineInOut())))), this.wing_l.runAction(cc.repeatForever(cc.sequence(cc.scaleTo(.2, -1, 1).easing(cc.easeSineInOut()), cc.scaleTo(.2, -.4, 1).easing(cc.easeSineInOut()))))
                }, start: function () {}, setMosquitoSpeed: function () {
                    this.node.angle >= 360 ? this.node.angle -= 360 : this.node.angle < 0 && (this.node.angle += 360), this.mosquitoSpeedR = Math.random() * this.mosquitoSpeedMaxR * 2 - this.mosquitoSpeedMaxR;
                    var e = Math.random() * this.mosquitoTargetMaxR * (Math.abs(this.mosquitoSpeedR) / (this.mosquitoSpeedMaxR + .4 * this.mapScale));
                    this.mosquitoSpeedR > 0 ? (this.mosquitoTargetR = this.node.angle + e, this.mosquitoAddR = !0) : (this.mosquitoTargetR = this.node.angle - e, this.mosquitoAddR = !1), this.checkEdgeDelayCount = 0, this.onEdgeFlag && Math.abs(this.mosquitoSpeedR) > 2 && (this.mosquitoSpeedR = this.mosquitoSpeedR / 3 * 2, this.mosquitoTargetR = this.mosquitoTargetR / 3 * 2), this.onEdgeFlag = !1, this.turnNum--, this.turnNum <= 0 && (this.isTurn = !1)
    ...
    linkHttpIconJs: [
        function (e, t, n) {
            ...
            cc.Class({
                ...
                }, start: function () {}, addTouchEvents: function () {
                    var e = this,
                        t = {
